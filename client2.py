        ...
        # 需要做动作
            ...
            # 打牌
                ...
                if self.flag == 0:       # 总共牌减去初始手牌
                    ...
                    print(f"client2 has hand cards {message['handCards']}")
                ...
                if len(message['actionList']) == 1:
                    # print(f"client2 does action : {message['actionList'][0]}")
                ...
                #     self.send(json.dumps({"actIndex": randint(0, message["indexRange"])}))
                    ...
                    # print(f"client2 actionlist : {message['actionList']}")
                        ...
                        # print(f"client2 does action : {message['actionList'][int(act_index)]}")
                        self.send(json.dumps({"actIndex": int(act_index)}))
